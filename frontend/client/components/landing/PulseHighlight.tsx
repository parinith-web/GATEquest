  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <div
          className="relative flex flex-col items-center justify-center gap-2 overflow-x-auto py-6 no-scrollbar md:overflow-visible md:-translate-x-2 md:gap-3 md:py-10 lg:-translate-x-4"
          style={{
            WebkitMaskImage:
